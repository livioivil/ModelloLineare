##' @description Funzione che dato il percorso dei dati del profilo facebook ritorna il numero delle differenti attivit? che compaiono sul wall
...
##' @return dataset (1x7) contenente le informazioni delle attivit? sul Wall
##' @title getWall
##' @export
##' 
